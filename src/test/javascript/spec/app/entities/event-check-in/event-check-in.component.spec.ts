...
import { EventCheckInComponent } from 'app/entities/event-check-in/event-check-in.component';
...
describe('Component Tests', () => {
  describe('EventCheckIn Management Component', () => {
    let comp: EventCheckInComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(EventCheckInComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.eventCheckIns[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
